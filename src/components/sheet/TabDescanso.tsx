    ...
    >
      <Panel full>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(min(100%, 230px), 1fr))', gap: 14 }}>
          <button onClick={() => store.shortRest(char.id)} style={{ cursor: 'pointer', textAlign: 'left', borderRadius: 14, padding: '16px 18px', border: '1px solid var(--line)', background: 'rgba(0,0,0,.26)', transition: '.25s' }}>
          ...
          <button onClick={() => store.longRest(char.id)} style={{ cursor: 'pointer', textAlign: 'left', borderRadius: 14, padding: '16px 18px', border: '1px solid var(--goldB)', background: 'linear-gradient(160deg, rgba(255,224,138,.14), rgba(255,224,138,.04))', boxShadow: '0 0 26px var(--bloom)', transition: '.25s' }}>
