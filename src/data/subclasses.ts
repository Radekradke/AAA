...
export const SUBCLASSES: Subclass[] = [
  ...
  // Clérigo
  { id: 'life', classId: 'cleric', label: 'Domínio da Vida', desc: 'Curandeiro supremo da fé.', features: { 1: ['Discípulo da Vida', 'Proficiência com armadura pesada'], 2: ['Canalizar: Preservar a Vida'], 6: ['Curandeiro Abençoado'], 8: ['Golpe Divino'], 17: ['Cura Suprema'] }, bonuses: { proficiencies: ['Armadura pesada'] } },
  ...
  { id: 'war', classId: 'cleric', label: 'Domínio da Guerra', desc: 'Braço armado da divindade.', features: { 1: ['Sacerdote da Guerra', 'Proficiências marciais'], 2: ['Canalizar: Golpe Dirigido'], 6: ['Canalizar: Bênção do Deus da Guerra'], 8: ['Golpe Divino'], 17: ['Avatar da Batalha'] }, bonuses: { proficiencies: ['Armadura pesada', 'Armas marciais'] } },
  // Druida
